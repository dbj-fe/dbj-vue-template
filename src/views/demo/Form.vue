      ...
      >
        <div class="form-section">
          <div class="form-section-header">
            <div class="form-section-header-col">信息1<span class="tip">价格信息会在生成物料清单及报价时显示</span></div>
          </div>
            ...
            >
              <ul class="form-items-horizonal">
                ...
                <li>
                  <el-input
                    placeholder="0"
                    v-model="formData.kitchen"
                  >
                    <template slot="suffix">厨</template>
                  </el-input>
                </li>
                <li>
                  <el-input
        ...
        <div class="form-section">
          <div class="form-section-header">
            <div class="form-section-header-col">信息1</div>
          </div>
          <div class="form-section-body">
            <el-form-item label="活动名称">
              <el-input v-model="formData.name"></el-input>
